...
export const RESULTADOS: Jornada[] = [
  ...
  { jornada: 5, fecha: "12/09/2026", rival: "UD Almería", estadio: "Nuevo Arcángel", resultado: "0 - 2", local: true, victoria: false, empate: false },
  { jornada: 6, fecha: "18/09/2026", rival: "Albacete Balompié", estadio: "Carlos Belmonte", resultado: "1 - 2", local: false, victoria: true, empate: false },
